...
def main(args):
    ...
    model = KeyedVectors.load_word2vec_format("/home/vyhuy/Downloads/word2vec_vi_words_100dims.txt", binary=False)
    print('vocab built in {}'.format(timedelta(seconds=time()-start)))
    #model.train(sentences, total_examples=model.corpus_count, epochs=model.iter)
    
    model.save(join(save_dir, 'word2vec.{}d.{}k.txt'.format(
